...
def main():
    ...
    pairs = [
        ("R_REBOUND", "R_FORM"),
        ("R_REBOUND", "R_NO_GROWTH"),
        ("HY_C_BASE", "HY_R_FORM"),
        ("HY_C_REBOUND", "HY_C_BASE"),
        ("HY_RB_BASE", "HY_C_BASE"),
        ("HY_RB_REBOUND", "HY_RB_BASE"),
        ("HY_RB_REBOUND", "HY_C_REBOUND"),
        ("HY_RB_REBOUND", "HY_R_FORM"),
        ("HY_C_REBOUND", "HY_R_FORM"),
    ]
