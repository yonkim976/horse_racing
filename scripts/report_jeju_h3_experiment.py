...
def main():
    ...
    pairs = [
        (candidate, reference)
        for candidate in ["P_H3", "R_H3", "P_H3R", "R_H3R"]
        for reference in ["M0_H2", "P_H2"]
    ]
    pairs += [("P_H3R", "P_H3"), ("R_H3R", "R_H3")]
