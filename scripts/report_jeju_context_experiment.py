...
def main():
    ...
    pairs = [
        (candidate, reference)
        for candidate in ["R_CTX", "R_FORM", "HY_R_H3", "HY_R_FORM"]
        for reference in ["M0_H2", "P_H3", "R_H3", "J_H3_w10"]
    ]
    pairs += [("R_FORM", "R_CTX"), ("HY_R_FORM", "R_FORM")]
                ...
                reliability.append(
                    {
                        ...
                        if source == "PL" and m.startswith(("J_", "HY_"))
                        else source,
                        "bucket": bucket,
                        "races": len(part),
    ...
    save(
        "analysis_metadata.json",
        {
            ...
            "references": ["M0_H2", "P_H3", "R_H3", "J_H3_w10"],
