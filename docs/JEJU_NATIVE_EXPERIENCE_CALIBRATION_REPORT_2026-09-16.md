...
|---|---:|---:|---:|---:|---:|
| 같은 거리 경험 0회 | 1,137 | 39.38% | 36.50% | +2.88%p [+0.74, +5.12] | 36.99% |
| 같은 거리 경험 1~2회 | 1,461 | 37.38% | 36.34% | +1.03%p [-0.90, +2.99] | 37.40% |
| 같은 거리 경험 3~5회 | 1,236 | 31.68% | 32.61% | -0.92%p [-3.29, +1.37] | 32.24% |
| 같은 거리 경험 6회 이상 | 3,060 | 24.24% | 25.42% | -1.19%p [-2.22, -0.16] | 24.89% |
| 지정 구간 변수 관측 | 6,602 | 30.46% | 30.85% | -0.40%p [-0.57, -0.22] | 30.62% |
| 지정 구간 변수 결측 | 292 | 39.83% | 30.82% | +9.01%p [+5.02, +13.31] | 36.03% |
...
|---|---:|---:|---:|
| 기존 모델 | 454/715 (63.50%) | 57/715 (7.97%) | 21/715 (2.94%) |
| 전체 온도 보정·선택 유지 | 454/715 (63.50%) | 57/715 (7.97%) | 21/715 (2.94%) |
| 경험·결측 보정·선택 유지 | 454/715 (63.50%) | 57/715 (7.97%) | 21/715 (2.94%) |
| 경험·결측 보정·다시 선택 | 454/715 (63.50%) | 57/715 (7.97%) | 19/715 (2.66%) |
...
|---|---:|---:|---:|---:|
| 기존 모델 | 0.183670 | 0.547123 | 4.060630 | 5.751719 |
| 전체 온도 보정·선택 유지 | 0.183734 | 0.547285 | 4.062364 | 5.753426 |
| 경험·결측 보정·선택 유지 | 0.183239 | 0.546030 | 4.051743 | 5.742810 |
| 경험·결측 보정·다시 선택 | 0.183239 | 0.546030 | 4.051743 | 5.742810 |

아래 차이는 후보−기준이며 경주일 단위 짝지은 재표본 5,000회의 95% 구간이다.

| 후보 − 기준 | Brier 차이 [구간] | 입상 로그손실 차이 [구간] |
|---|---:|---:|
| C_GLOBAL_FIXED − HY_R_FORM | +0.00006339 [-0.00007996, +0.00021218] | +0.00016179 [-0.00025209, +0.00057832] |
| C_EXPERIENCE_FIXED − C_GLOBAL_FIXED | -0.00049466 [-0.00087752, -0.00009945] | -0.00125485 [-0.00214022, -0.00036314] |
| C_EXPERIENCE_FIXED − HY_R_FORM | -0.00043127 [-0.00084697, -0.00000141] | -0.00109306 [-0.00207921, -0.00007461] |
| C_EXPERIENCE_SELECT − HY_R_FORM | -0.00043127 [-0.00084697, -0.00000141] | -0.00109306 [-0.00207921, -0.00007461] |
| C_EXPERIENCE_SELECT − C_EXPERIENCE_FIXED | +0.00000000 [+0.00000000, +0.00000000] | +0.00000000 [+0.00000000, +0.00000000] |
...
|---|---:|---:|
| 기존 모델 | 0.018238 | 0.024936 |
| 전체 온도 보정·선택 유지 | 0.018680 | 0.026299 |
| 경험·결측 보정·선택 유지 | 0.021066 | 0.029152 |
...
|---|---:|---:|---:|---:|---:|---:|
| dev_2025_q1 | -0.0369 | -0.0270 | -0.0425 | +0.0321 | +0.0000 | -0.0438 |
| dev_2025_q2 | -0.0183 | -0.1626 | -0.0529 | -0.0062 | +0.0000 | -0.2655 |
| dev_2025_q3 | +0.0040 | -0.2824 | -0.1224 | -0.0328 | +0.0000 | -0.2066 |
| dev_2025_q4 | -0.0018 | -0.2054 | -0.0954 | -0.0913 | +0.0000 | -0.2725 |
