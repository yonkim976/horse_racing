...
|---|---:|---:|---:|
| P_H3 | 445/715 (62.24%) | 52/715 (7.27%) | 14/715 (1.96%) |
| R_H3 | 437/715 (61.12%) | 57/715 (7.97%) | 15/715 (2.10%) |
| M0_H2 | 425/715 (59.44%) | 49/715 (6.85%) | 18/715 (2.52%) |
| J_H3_w05 | 446/715 (62.38%) | 40/715 (5.59%) | 15/715 (2.10%) |
| J_H3_w10 | 446/715 (62.38%) | 44/715 (6.15%) | 17/715 (2.38%) |
...
|---|---|
| 한 마리: P_H3 대비 | +0.14, 95% 구간 [-2.84, +3.06] |
| 세 마리: R_H3 대비 | -1.82, 95% 구간 [-3.76, +0.00] |
| 정확 순위: M0_H2 대비 | -0.14, 95% 구간 [-1.56, +1.26] |
...
|---|---:|---:|---:|
| J_H3_w05 | 0.186720 | 4.119754 | 5.812671 |
| J_H3_w10 | 0.186718 | 4.119577 | 5.810638 |
| M0_H2 | 0.192707 | 4.262581 | 6.003683 |
| P_H3 | 0.185874 | 4.111055 | 5.839296 |
| R_H3 | 0.187595 | 4.149321 | 5.877056 |
...
- 16회 모두 사전 지정100회 반복 한도에 도달했다. 수학적 수렴 완료로 기록하지 않았다. TUNE이 선택한 모델은10~45회 시점이며, 최대 반복 후 모델을 무조건 사용하지 않았다. 모든 보정8회는 수렴했고 경계에 걸리지 않았다.
